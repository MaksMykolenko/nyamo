  ...
  const TRANSLATIONS = {
    uk: {
      ...
      playground: {
        ...
        title: "Спробуй прямо в браузері",
        desc: "Обери продукти, які зараз є у твоєму холодильнику. Алгоритм <strong>RecipeMatcher</strong> миттєво підрахує відповідність рецептів у реальному часі!",
    ...
    en: {
      ...
      playground: {
        ...
        title: "Try It Directly in Your Browser",
        desc: "Pick ingredients you currently have in your kitchen. Our <strong>RecipeMatcher</strong> algorithm recalculates matched dishes in real time!",
    ...
    tr: {
      ...
      playground: {
        ...
        title: "Doğrudan Tarayıcınızda Deneyin",
        desc: "Şu anda buzdolabınızda bulunan malzemeleri seçin. <strong>RecipeMatcher</strong> algoritması eşleşen yemekleri anında hesaplasın!",
