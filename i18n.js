  ...
  const TRANSLATIONS = {
    uk: {
      ...
      playground: {
        ...
        fridgeLabel: "Що є вдома?",
        fridgeTitle: "Що є вдома?",
        selectedCount: "Вибрано: {n}",
        presetLabel: "Приклад:",
        presetBreakfast: "Сніданок",
        presetPotato: "Картопля",
        presetPasta: "Паста",
        presetReset: "Очистити вибір",
        allProducts: "Усі продукти (+{n})",
        allProductsWithSelected: "Усі продукти (+{n} · {sel} вибрано)",
        showLess: "Згорнути",
        pantryTitle: "Базові продукти",
        pantrySelected: "{n} вибрано",
        resultsTitle: "Що приготувати",
        resultsEmpty: "Оберіть продукти ліворуч або скористайтеся готовим набором",
        resultsReady: "🟢 Готово до приготування: {n} {plural}",
        resultsPartial: "🟡 Підібрано {n} {plural} (бракує кількох продуктів)",
        resultsHint: "Змінюй продукти — дивись, які страви підходять",
        showMoreRecipes: "Показати ще {n}",
        cardReadyStatus: "✓ Усі інгредієнти вибрано",
        cardMissingSingle: "Бракує: {item}",
        cardMissingMultiple: "Потрібно ще {n} продукти",
        cardOpenRecipe: "Відкрити рецепт →",
      ...
      download: {
        ...
        desc: "Допоможи нам зробити додаток зручнішим. Надішли запит, щоб отримати доступ до бета-тестування на Android.",
      ...
      faq: {
        ...
        a2: "Ти можеш надіслати запит на пошту buisness@neoflux.fluxmarketplace.store, щоб отримати доступ до бета-тестування для Android та ділитися відгуками.",
    ...
    pl: {
      ...
      playground: {
        ...
        fridgeLabel: "Co masz w domu?",
        fridgeTitle: "Co masz w domu?",
        selectedCount: "Wybrano: {n}",
        presetLabel: "Przykład:",
        presetBreakfast: "Śniadanie",
        presetPotato: "Ziemniaki",
        presetPasta: "Makaron",
        presetReset: "Wyczyść wybór",
        allProducts: "Wszystkie produkty (+{n})",
        allProductsWithSelected: "Wszystkie produkty (+{n} · {sel} wybrano)",
        showLess: "Zwiń",
        pantryTitle: "Podstawowe produkty",
        pantrySelected: "{n} wybrano",
        resultsTitle: "Co ugotować",
        resultsEmpty: "Wybierz składniki po lewej lub skorzystaj z gotowego zestawu",
        resultsReady: "🟢 Gotowe do przygotowania: {n} {plural}",
        resultsPartial: "🟡 Znaleziono {n} {plural} (brakuje kilku składników)",
        resultsHint: "Zmieniaj składniki — zobacz, jakie dania pasują",
        showMoreRecipes: "Pokaż jeszcze {n}",
        cardReadyStatus: "✓ Wszystkie składniki wybrane",
        cardMissingSingle: "Brakuje: {item}",
        cardMissingMultiple: "Potrzeba jeszcze {n} składniki",
        cardOpenRecipe: "Zobacz przepis →",
      ...
      download: {
        ...
        desc: "Pomóż nam ulepszyć aplikację. Wyślij zgłoszenie, aby uzyskać dostęp do testów beta na Androidzie.",
      ...
      faq: {
        ...
        a2: "Możesz wysłać wiadomość na buisness@neoflux.fluxmarketplace.store, aby otrzymać dostęp do testów na Androidzie i przekazywać swoje uwagi.",
    ...
    en: {
      ...
      playground: {
        ...
        fridgeTitle: "What's in your kitchen?",
        selectedCount: "Selected: {n}",
        presetLabel: "Example:",
        presetBreakfast: "Breakfast",
        presetPotato: "Potatoes",
        presetPasta: "Pasta",
        presetReset: "Clear selection",
        allProducts: "All products (+{n})",
        allProductsWithSelected: "All products (+{n} · {sel} selected)",
        showLess: "Show less",
        pantryTitle: "Pantry essentials",
        pantrySelected: "{n} selected",
        resultsTitle: "What to cook",
        resultsEmpty: "Select ingredients on the left or try a preset",
        resultsReady: "🟢 Ready to cook: {n} {plural}",
        resultsPartial: "🟡 Found {n} {plural} (missing a few ingredients)",
        resultsHint: "Toggle ingredients — see which dishes match",
        showMoreRecipes: "Show {n} more",
        cardReadyStatus: "✓ All ingredients selected",
        cardMissingSingle: "Missing: {item}",
        cardMissingMultiple: "Needs {n} more ingredients",
        cardOpenRecipe: "View recipe →",
      ...
      download: {
        ...
        desc: "Help us shape the app. Send us a note to join the Android beta testing group.",
      ...
      faq: {
        ...
        a2: "You can email us at buisness@neoflux.fluxmarketplace.store to request access to the Android beta build and share your feedback.",
